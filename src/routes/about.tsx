    ...
    <>
      ...
      <main className="pt-32">
        ...
        <section className="container-prose grid lg:grid-cols-2 gap-12 items-center pb-24">
          <img src={clubhouse} alt="Clubhouse" className="w-full aspect-[4/3] object-cover" loading="lazy" />
          <div>
            <p className="text-lg text-muted-foreground leading-relaxed">
              Balaton Hills was founded with a singular ambition: to bring the
              traditions of championship golf to one of Europe's most evocative
              landscapes. Set between vineyards, basalt hills and the silver
              expanse of Lake Balaton, the estate honours a centuries-old
              Hungarian sense of place.
            </p>
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              From the stone clubhouse to the bent-grass greens, every detail is
              shaped by the conviction that the finest golf is the slowest —
              walked, savoured, and earned.
            </p>
          </div>
        </section>
      </main>

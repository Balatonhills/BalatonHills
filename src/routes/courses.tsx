      ...
      <main className="pt-32">
        <section className="container-prose text-center pb-20">
          ...
          <p className="mt-8 max-w-2xl mx-auto text-lg text-muted-foreground">
            Each course at Balaton Hills was conceived as a singular expression of its landscape —
            sister tracks of distinct character, united by an uncompromising pursuit of championship
            craft.
          </p>
        </section>
          ...
          <section key={c.slug} className={i % 2 ? "bg-secondary/40 py-24" : "py-24"}>
            <div className="container-prose grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <div className="mt-3 text-sm tracking-[0.25em] uppercase text-muted-foreground">
                  {c.stats}
                </div>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <Link
                    to="/booking"
                    className="bg-primary text-primary-foreground px-6 py-3 text-xs tracking-[0.25em] uppercase"
                  >
                    Book this Course
                  </Link>
